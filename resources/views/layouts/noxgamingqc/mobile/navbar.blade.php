        ...
        <div class="navbar-header" style="margin: 16px;">
            ...
            <div class="col-md-12">
                <ul id="aboutMeMenu" class="text-center hidden" hidden>
                    <a class="text-color" href="/{{app()->getLocale()}}/about_us/contact" style="font-size:14px"><li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><i class="fa fa-address-book " aria-hidden="true"></i> {{trans('general.contact_us')}}</li></a>
                    <a class="text-color" href="/{{app()->getLocale()}}/about_us/games" style="font-size:14px"><li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><i class="fa fa-gamepad" aria-hidden="true"></i> {{ trans('general.games_list') }}</li></a>
                    ...
                    <a class="text-color" href="/{{app()->getLocale()}}/about_us/projects" style="font-size:14px"><li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><i class="fa fa-heart" aria-hidden="true"></i> {{ trans('general.projects') }}</li></a>
                    ...
                    <a class="text-color" href="/{{app()->getLocale()}}/about_us/twitch" style="font-size:14px"><li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><i class="fa fa-twitch" aria-hidden="true"></i> {{ trans('general.twitch') }}</li></a>
                    <a class="text-color" href="/{{app()->getLocale()}}/about_us/youtube"  style="font-size:14px"><li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><i class="fa fa-youtube-play" aria-hidden="true"></i> {{ trans('general.youtube') }}</li></a>
                </ul>
                @auth
