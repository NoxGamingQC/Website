    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-navbar-collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="https://noxgamingqc-{{app()->getLocale()}}.square.site" class=""><i class="fa fa-shopping-cart" aria-hidden="true"></i> {{ trans('store.store') }}</a></li>
                @auth
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                @if(Auth::user()->local_mail)
                                    <a href="/mailbox"><i class="fa fa-envelope" aria-hidden="true"></i> {{trans('general.mail')}}</a>
                                @endif
