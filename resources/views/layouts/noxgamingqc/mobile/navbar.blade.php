        ...
        <div class="navbar-header" style="margin: 16px;">
            ...
            <div class="col-md-12">
                ...
                <ul id="premiumMenu" class="text-center hidden" hidden>
                    <li class="no-decoration" style="padding:5%;margin:2%;border:2px solid white"><a class="text-color" href="/{{app()->getLocale()}}/cookbook" style="font-size:14px">{{trans('cookbook.title')}}</a></li>
                </ul>
