                    ...
                    <div class="row">
                        @foreach($feed->get_items() as $item)
                            <div class="col-md-3 py-2">
                                <div class="card">
                                    <img src="{{ preg_match('/<img.+src=[\'"](?P<src>.+?)[\'"].*>/i', $item->get_description(), $image) ? $image['src'] : ($item->get_source() ? $item->get_source()->get_image_url() : '/img/no-image.png')}}" class="card-img-top" alt="..." max-height="200px" style="object-fit: cover; height: 200px;">
                                    <div class="card-body">
