<div class="modal fade" id="addGame" tabindex="-1" aria-labelledby="addGame" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">{{trans('game.add_game')}}</h4>
