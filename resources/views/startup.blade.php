    ...
    <div class="row py-5 align-items-center">
        <div class="col">
            ...
            <div class="input-group mb-3">
                <input id="searchInput" type="text" class="form-control form-control-lg" placeholder="{{trans('startup.search_placeholder')}}" autofocus style="box-shadow: 0 0 0 0.25rem transparent" />
