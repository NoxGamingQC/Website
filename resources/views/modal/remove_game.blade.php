<div class="modal fade" id="removeGame" tabindex="-1" aria-labelledby="removeGame" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">{{trans('game.remove_game')}}</h4>
