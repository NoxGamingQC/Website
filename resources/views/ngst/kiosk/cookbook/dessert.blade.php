...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 text-center" style="margin-bottom:3%">
            <a href="/{{app()->getLocale()}}/kiosk/cookbook/dessert/crema_di_caffe"><input class="btn btn-primary form-control" style="font-size:18px;padding:10%" value="{{trans('cookbook.crema_di_caffe')}}" readonly></a>
        </div>
        <div class="col-sm-4 text-center" style="margin-bottom:3%">
