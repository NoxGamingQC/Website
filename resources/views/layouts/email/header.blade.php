<table width="100%" border="0" cellspacing="0" cellpadding="0" class="em_full_wrap" align="center"  bgcolor="#111">
    <tr>
            ...
            <tr>
                <td align="center" valign="top">
                    <a href="https://www.noxgamingqc.ca" target="_blank" style="text-decoration:none;">
                        <img src="https://noxgamingqc.ca/img/@yield('brand').png" width="150"  alt="NGST" border="0" style="display:block; font-family:Arial, sans-serif; font-size:18px; line-height:25px; text-align:center; color:#fff; font-weight:bold; max-width:208px;" class="em_w150" />
                    </a>
                </td>
            </tr>
            <tr>
