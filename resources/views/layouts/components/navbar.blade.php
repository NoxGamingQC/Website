    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <ul class="nav nav-pills ms-auto justify-content-end">
            ...
            @guest
                ...
                <li class="nav-item">
                    <a class="nav-link {{isset($currentPage) ? ($currentPage == 'register' ? 'active' : '') : ''}}" href="/{{app()->getLocale()}}/register"><i class="fa fa-user-plus" aria-hidden="true"></i> {{trans('navigation.register')}}</a>
                </li>
            @endguest
            @auth
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{isset($currentPage) ? ($currentPage == 'my-profile' ? 'active' : '') : ''}}" href="/{{app()->getLocale()}}/user/{{strtolower(Auth::user()->name)}}"><i class="fa fa-user" aria-hidden="true"></i> {{trans('navigation.my_profile')}}</a></li>
                        <li><a class="dropdown-item" href="/{{app()->getLocale()}}/logout"><i class="fa fa-sign-out" aria-hidden="true"></i> {{trans('navigation.logout')}}</a></li>
                    </ul>
                </li>
            @endauth
        </ul>
