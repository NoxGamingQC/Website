                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <div class="text-center">
                                @if($user['avatarURL'])
                                    <img class="img img-circle status-offline" src="{{$user['avatarURL']}}" alt="{{$user['username']}}" title="{{$user['username']}}" width="100px" />
                                @else
                                    <img class="img img-circle status-offline" src="/img/no-avatar.jpg" alt="{{$user['username']}}" title="{{$user['username']}}" width="100px" />
                                @endif
                                <h4>
                                    <b>
                                        @if($user['isPremium'])
