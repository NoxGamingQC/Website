    ...
    <div class="row">
        ...
        <div class="col-md-12" id="socialNetwork">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-2" id="googlePlus">
                    <a class="btn btn-google-plus btn-lg" href="https://plus.google.com/u/0/114349968576126625828">
                        <i class="fa fa-google-plus-circle fa-5x" aria-hidden="true"></i>
                    </a>
                    <p>NoxGamingQC</p>
                </div>
